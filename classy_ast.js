...
var $0 = $$.length - 1;
switch (yystate) {
case 1:this.$ = ['PROGRAM',{},$$[$0-6],$$[$0-3],$$[$0-2]]; alert(this.$);return this.$;
break;
case 2:this.$ = $$[$0].push($$[$0-1]); alert($$[$0]);alert($$[$0-1]);
break;
case 3:this.$ = ['CLASS_DECL_LIST',{}];
break;
case 4:this.$ = ['CLASS_DECL',{},$$[$0-6],$$[$0-4],$$[$0-2],$$[$0-1]];
break;
case 5:this.$ = $$[$0].push(['VAR_DECL',{},$$[$0-3],$$[$0-2]]);
break;
case 6:this.$ = ['VAR_DECL_LIST',{}];
break;
case 7:this.$ = $$[$0].push(['METHOD_DECL',{},$$[$0-10],$$[$0-9],$$[$0-7],$$[$0-6],$$[$0-3],$$[$0-2]]);
break;
...
lexer.rules = [/^\/\/.*/,/^main\b/,/^class\b/,/^extends\b/,/^nat\b/,/^if\b/,/^else\b/,/^for\b/,/^printNat\b/,/^readNat\b/,/^this\b/,/^new\b/,/^var\b/,/^null\b/,/^[0-9]+/,/^[a-zA-Z][a-zA-Z0-9]*/,/^==/,/^=/,/^\+/,/^-/,/^\*/,/^>/,/^\|\|/,/^!/,/^\./,/^\{/,/^\}/,/^\(/,/^\)/,/^;/,/^\s+/,/^\./,/^$/];
